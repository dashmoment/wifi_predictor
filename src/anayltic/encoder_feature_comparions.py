...
#    tsne_plotter.plot()
    ...
    anova_filter = SelectKBest(f_regression, k=20).fit(train, label_train['delay_mean'])
    mask = anova_filter.get_support(indices=True)
    ...
    saveModel_cb = keras_event_callBack.saveModel_Callback(
                                                            10,
                                                            rahul_model,
                                                            '../../trained_model/nn_model_rahul/nn_model_rahul.json',
                                                            '../../trained_model/nn_model_rahul/nn_model_rahul.h5'
                                                            )
    tensorBoard_cb = keras_event_callBack.tensorBoard_Callback(log_dir='../../trained_model/nn_model_rahul/logs')
