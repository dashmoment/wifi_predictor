...
class feature_extraction:
    ...
    def get_train_test_interval(self, data_length, num_interval=4000, time_step=15):
    ...
    def generator(self, coll_prefix, time_step = 15, special_list = [], embed_model_path = ""):
            ...
            training_interval, testing_interval = self.get_train_test_interval(len(fdata), time_step=time_step)
            ...
            train = pd.concat([TimeRecord, train], axis = 1)
            ...
            TimeRecord = pd.DataFrame(TimeRecord)
            test = pd.concat([TimeRecord, test], axis=1)
